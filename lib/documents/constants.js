...
export const FEES = {
  EarlyBird: { student: 60, eastAfrica: 400, other: 400 },
  // Regular aligns with early-bird rate; Late / On-site is the on-site rate.
  Regular: { student: 75, eastAfrica: 400, other: 400 },
  LateOnsite: { student: 90, eastAfrica: 450, other: 450 },
};
...
export const PHASE_WINDOWS = {
  ...
  LateOnsite: {
    ...
    label: "Late / On-site: Jul 1 – Oct 17, 2026",
  },
};
