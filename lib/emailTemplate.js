...
export const specialInviteTemplate = ({ name, amount, inviteUrl, note }) => `
  <div style="font-family: Arial, Helvetica, sans-serif; background:#f7f7f7; padding:40px 20px;">
    <div style="max-width:600px; margin:auto; background:#ffffff; border-radius:8px; overflow:hidden; border:1px solid #e5e5e5;">

      <!-- Header -->
      <div style="background:#ea580c; padding:24px; text-align:center; color:white;">
        <h1 style="margin:0; font-size:22px;">A Special Invitation</h1>
        <p style="margin:8px 0 0 0; font-size:14px;">Africa Childcare Forum &middot; Mombasa 2026</p>
      </div>

      <!-- Body -->
      <div style="padding:30px;">
        <p style="font-size:16px;">Dear <strong>${name || "Guest"}</strong>,</p>

        <p style="font-size:15px; line-height:1.6;">
          On behalf of <strong>Uthabiti Africa</strong>, it is my pleasure to personally invite you to the
          <strong>Africa Childcare Forum (ACF) Mombasa 2026</strong>. Your voice and experience would be a
          valuable addition to the conversations shaping the future of childcare across Africa.
        </p>

        ${
          note
            ? `<div style="margin:20px 0; border-left:4px solid #ea580c; padding:12px 16px; background:#fff7ed; font-size:14px; line-height:1.6; color:#444;">
          ${note}
        </div>`
            : ""
        }
        ...
        <p style="font-size:15px; line-height:1.6;">
          As my special guest, a dedicated registration has been arranged for you at a rate of:
        </p>

        <div style="margin:20px 0; text-align:center; border:1px solid #fed7aa; border-radius:8px; padding:20px; background:#fff7ed;">
          <p style="margin:0; font-size:13px; color:#9a3412; text-transform:uppercase; letter-spacing:1px;">Your Registration Rate</p>
          <p style="margin:8px 0 0 0; font-size:32px; font-weight:bold; color:#ea580c;">$${amount} USD</p>
        </div>

        <p style="font-size:15px; line-height:1.6;">
          Please use your personal registration link below to complete your registration.
          This link is unique to you and applies your special rate automatically.
        </p>

        <p style="text-align:center; margin:30px 0;">
          <a
            href="${inviteUrl}"
            style="display:inline-block; padding:14px 28px; background:#ea580c; color:#ffffff; text-decoration:none; border-radius:6px; font-size:16px; font-weight:bold;"
          >
      ...
      <div style="background:#fafafa; padding:18px; text-align:center; font-size:12px; color:#777;">
        ...
        This invitation link is personal and intended only for the recipient of this email.
      </div>
...
export const invoiceEmailTemplate = ({
  ...
  const pendingHint =
    currency === "KES"
      ? "Please complete payment using the Family Bank KES Paybill / account details on the invoice (include the Payment Ref), or pay online via the registration portal."
      : "Please complete your payment online via the registration portal, or use the USD bank details on the invoice with the Payment Ref shown above.";
  ...
  <div style="font-family: Arial, Helvetica, sans-serif; background:#f7f7f7; padding:40px 20px;">
    <div style="max-width:600px; margin:auto; background:#ffffff; border-radius:8px; overflow:hidden; border:1px solid #e5e5e5;">
      <div style="background:#ea580c; padding:24px; text-align:center; color:white;">
        ...
        <p style="margin:8px 0 0 0; font-size:14px;">ACF Mombasa 2026 · ${currency}</p>
      </div>
      <div style="padding:30px;">
        <p style="font-size:16px;">Dear <strong>${name}</strong>,</p>
        <p style="font-size:15px; line-height:1.6;">
          Thank you for registering for the <strong>Africa Childcare Forum (ACF) Mombasa 2026</strong>.
          Please find your ${currency} invoice attached to this email.
        </p>
        <div style="margin:25px 0; border:1px solid #eee; border-radius:6px; padding:20px; background:#fafafa;">
          <table style="width:100%; font-size:14px; border-collapse:collapse;">
            ...
            <tr>
              ...
              <td style="padding:6px 0;"><strong>${displayAmount}</strong></td>
            </tr>
            <tr>
              <td style="padding:6px 0; color:#555;">Currency:</td>
    ...
    <div style="max-width:600px; margin:auto; background:#ffffff; border-radius:8px; overflow:hidden; border:1px solid #e5e5e5;">
      ...
      <div style="padding:30px;">
        ...
        <p style="font-size:14px; line-height:1.6;">
          ${
            phase === "LateOnsite"
              ? "Please complete your payment online to confirm your participation — your invoice with payment details has also been sent to you. If needed, payment can still be completed at the conference venue during check-in."
